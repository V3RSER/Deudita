        ...
        <form onSubmit={handleSave} className="flex-1 overflow-y-auto px-5 sm:px-6 py-5 space-y-6">
          ...
          {!isOnboarding && (
            <div className="space-y-3">
              ...
              <div className="bg-gradient-to-br from-zinc-50 via-white to-zinc-50 border border-zinc-200 rounded-2xl p-4 sm:p-5 space-y-3 shadow-2xs">
                <p className="text-xs text-zinc-600 leading-relaxed">
                  {gmailConnected
          ...
          {!isOnboarding && (
            <div className="space-y-3">
              ...
              <div className="bg-white border border-zinc-200 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs">
                <div className="space-y-0.5 max-w-md">
                  <p className="text-xs font-bold text-zinc-900">
                    Reglas de Extracción y Formatos Bancarios
                  </p>
                  <p className="text-xs text-zinc-500 leading-normal">
                    Configura expresiones regulares, formatos de bancos y prueba la extracción de montos y comercios directamente con tus correos.
                  </p>
                </div>
                <button
                  type="button"
