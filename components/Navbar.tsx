...
export function Navbar({
    ...
    return (
        <>
                            ...
                            <div className="relative">
                                ...
                                >
                                    {currentProfile.avatar_url ? (
                                        ...
                                        <div
                                            className="w-8.5 h-8.5 rounded-full bg-zinc-950 text-white flex items-center justify-center text-xs font-bold shadow-2xs">
            ...
            <nav
                className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-zinc-200/80 px-2 py-1.5 pb-[calc(0.5rem+env(safe-area-inset-bottom,0px))] flex items-center justify-around shadow-lg">
                {/* Tab 1: Inicio */}
                <button
                    onClick={() => setActiveTab('dashboard')}
            ...
            {isMobileMenuOpen && (
                <div
                    className="lg:hidden fixed inset-0 z-50 bg-black/40 backdrop-blur-xs flex flex-col justify-end animate-in fade-in duration-150">
                    <div
                        className="bg-white rounded-t-3xl p-5 space-y-3 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))] shadow-2xl border-t border-zinc-200">
