...
export function PaymentInstructionsView({instructions}: PaymentInstructionsViewProps) {
    ...
    return (
        <div
            className="relative overflow-hidden bg-gradient-to-br from-emerald-50/90 via-emerald-50/50 to-teal-50/70 border border-emerald-200/70 rounded-2xl p-4 sm:p-4.5 text-xs text-zinc-800 shadow-2xs space-y-2.5">
            ...
            <div
                className="bg-white/80 backdrop-blur-xs p-3 rounded-xl border border-emerald-100 leading-relaxed font-medium text-zinc-800 whitespace-pre-wrap">
                {elements}
            </div>
        </div>
    );
