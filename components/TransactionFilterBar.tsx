    ...
    return (
        <div className="rounded-2xl border border-zinc-200/90 bg-white shadow-xs transition-all">
            ...
            {activeChips.length > 0 && (
                <div
                    className="flex flex-wrap items-center gap-1.5 border-t border-zinc-100 bg-zinc-50/50 px-3 py-2 sm:px-4">
            ...
            {isOpen && (
                <div
                    className="border-t border-zinc-200/90 bg-zinc-50/50 p-4 sm:p-5 space-y-4 rounded-b-2xl animate-in fade-in duration-150">
