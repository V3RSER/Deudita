                    ...
                    <div className="flex items-start space-x-3 min-w-0 flex-1">
                        ...
                        <div className="flex items-center -space-x-2 shrink-0 pt-0.5">
                            ...
                            {pairwise.creditor.avatar_url ? (
                                ...
                                <div
                                    className="w-10 h-10 rounded-full ring-2 ring-white bg-zinc-700 text-white flex items-center justify-center text-xs font-bold shrink-0">
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 pb-20 sm:pb-12">
            ...
            <div className="space-y-4">
                {/* Controls & Filter Bar */}
                <div
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-3xl border border-zinc-200/80 shadow-2xs">
                    {/* Filter Pills */}
