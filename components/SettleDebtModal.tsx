...
export function SettleDebtModal({
    ...
    const memberOptions = useMemo(() => {
        return profiles.map((p) => ({
            ...
            icon: p.avatar_url ? (
                ...
                <div
                    className="w-6 h-6 rounded-full bg-zinc-900 text-white flex items-center justify-center text-[10px] font-bold shrink-0">
    ...
    return (
        <div
            className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-zinc-950/50 backdrop-blur-md overflow-y-auto">
            <div
                className="bg-white rounded-[28px] shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[92vh] ring-1 ring-zinc-200/80 animate-in fade-in zoom-in-95 duration-150">
                ...
                <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5">
                    ...
                    <div
                        className="bg-zinc-50/90 border border-zinc-200/90 rounded-2xl p-3 sm:p-3.5 relative shadow-xs">
                        <div
                    ...
                    <div className="space-y-2">
                        ...
                        {proofUrl ? (
                            <div
                                className="flex items-center justify-between p-3 bg-emerald-50/70 border border-emerald-200/80 rounded-2xl">
                                <div className="flex items-center space-x-3 min-w-0">
                                    <div
                                        className="relative w-12 h-12 rounded-xl overflow-hidden shrink-0 border border-emerald-200">
                                        <Image
                                            src={proofUrl}
                                            alt="Comprobante"
                                            fill
                ...
                {/* Modal Footer */}
                <div
                    className="p-4 sm:px-6 border-t border-zinc-100 bg-zinc-50/90 flex items-center justify-between shrink-0">
                    {isEditing ? (
                        <button
                            type="button"
