                ...
                <div className="grid grid-cols-2 gap-2.5">
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <ChevronDown
                                className={`w-4 h-4 text-zinc-400 shrink-0 transition-transform ${activePicker === 'period' ? 'rotate-180 text-emerald-600' : ''
                                    }`}
                            />
                        </button>
                        ...
                        {activePicker === 'period' && (
                            <div
                                className="absolute left-0 right-0 top-full mt-1.5 bg-white border border-zinc-200 rounded-2xl shadow-xl p-1.5 z-50 max-h-60 overflow-y-auto animate-in fade-in zoom-in-95 duration-150">
                                            ...
                                            {availableMonths.map((month) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {isSelected && <Check
                                                            className="w-3.5 h-3.5 text-emerald-600 shrink-0 ml-2" />}
                                                    </button>
                                                );
                                            })}
                                        </div>
                    ...
                    <div className="relative">
                        ...
                        >
                            <div className="flex items-center gap-2.5 min-w-0">
                                {stagedFilters.category !== 'all' ? (
                                    (() => {
                                        ...
                                        return (
                                            <div
                                                className={`w-5 h-5 rounded-full ${catConfig.bgClass} ${catConfig.textClass} flex items-center justify-center shrink-0`}>
                            ...
                            <ChevronDown
                                className={`w-4 h-4 text-zinc-400 shrink-0 transition-transform ${activePicker === 'category' ? 'rotate-180 text-emerald-600' : ''
                                    }`}
                            />
                        </button>
                ...
                <div className="space-y-2">
                    ...
                    >
                        <div className="flex items-center gap-2.5">
                            ...
                            {moreFiltersCount > 0 && (
                                <span
                                    className="w-5 h-5 rounded-full bg-emerald-600 text-white text-[11px] font-bold flex items-center justify-center">
                                    {moreFiltersCount}
                                </span>
                            )}
                        </div>
                    ...
                    {isMoreFiltersOpen && (
                        <div
                            className="p-3.5 bg-zinc-50/70 border border-zinc-200/80 rounded-2xl space-y-3.5 animate-in fade-in duration-150">
                            {/* Participación (Scope) */}
