    ...
    return (
        ...
        >
            ...
            >
                ...
                <div
                    className="px-4 sm:px-6 py-2 bg-zinc-100/70 border-b border-zinc-200/70 flex items-center justify-between text-xs text-zinc-500 shrink-0">
                    <button
                        type="button"
                        ...
                        {expandedSections.recovers && (
                            <div className="border-t border-zinc-200/80 bg-zinc-50/40 p-3 sm:p-4 space-y-3">
                                {activeReverseExpenses.length === 0 && activeDirectPayments.length === 0 ? (
                                    <div
                                        className="p-5 text-center text-zinc-500 text-xs bg-white rounded-xl border border-zinc-200">
                                        <p className="font-semibold text-zinc-700">No hay aportes ni pagos directos
                                            pendientes a favor de {debtorName}.</p>
                                    </div>
                                ) : (
                                    <GenericExpenseList
                        ...
                        <div className="bg-white rounded-2xl border border-zinc-200/90 shadow-2xs overflow-hidden">
                            ...
                            {expandedSections.distribution && (
                                <div className="p-4 sm:p-5 border-t border-zinc-200/80 bg-zinc-50/40 space-y-4">
                                    <div
                                        className="bg-white rounded-2xl p-4 sm:p-6 border border-zinc-200/90 shadow-2xs space-y-5">
                                            ...
                                            return (
                                                <div className="space-y-4">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            className="inline-flex p-0.5 bg-zinc-100 rounded-xl border border-zinc-200/80 text-xs font-semibold self-start sm:self-auto">
                                                            <button
                                                                type="button"
                                                    ...
                                                    {graphMode === 'unsimplified' ? (
                                                        <div
                                                            className="p-3.5 sm:p-4 rounded-xl bg-rose-50/70 border border-rose-200/80 space-y-1.5">
                                                            <div
                                                                className="flex items-center space-x-2 text-rose-900 font-extrabold text-xs">
                                                                <span
                                                                    className="w-2 h-2 rounded-full bg-rose-500 shrink-0"></span>
                                                        ...
                                                        <div
                                                            className="p-3.5 sm:p-4 rounded-xl bg-emerald-50/70 border border-emerald-200/80 space-y-1.5">
                                                            <div
                                                                className="flex items-center space-x-2 text-emerald-900 font-extrabold text-xs">
                                                                <span
                                                                    className="w-2 h-2 rounded-full bg-emerald-500 shrink-0"></span>
                                                            ...
                                                            >
                                                                <div
                                                                    ...
                                                                    <div>
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                className="text-zinc-950 font-black">{sug.from.full_name || 'Deudor'}</span>{' '}
                                                                            <span className="text-zinc-500 font-medium">le debe pagar a</span>{' '}
                                                                            <span
                                                                                className="text-emerald-700 font-black">{sug.to.full_name || 'Tercero'}</span>
                                                                        </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    {onOpenSettleModal && (
                                                                        ...
                                                                        >
                                                                            Saldar
                                                                            con {sug.to.full_name?.split(' ')[0] || 'Tercero'}
                                                                        </button>
                                                                    )}
                                                                </div>
                                                            </div>
