...
interface ExpenseContextType {
    ...
    addGroupInvite: (groupId: string, email?: string, name?: string, memberId?: string) => Promise<{
        inviteUrl: string;
        message: string;
        memberId?: string
    }>;
    getGroupInviteLink: (groupId: string) => Promise<{
        inviteUrl: string;
        expiresAt: string;
        token: string;
        inviteId: string;
    ...
    regenerateGroupInviteLink: (groupId: string) => Promise<{
        inviteUrl: string;
        expiresAt: string;
        token: string;
        inviteId: string;
...
export function ExpenseProvider({ children }: { children: React.ReactNode }) {
    ...
    const addGroupInvite = async (groupId: string, email?: string, name?: string, memberId?: string): Promise<{
        inviteUrl: string;
        message: string;
        memberId?: string
    }> => {
    ...
    const getGroupInviteLink = useCallback(async (groupId: string): Promise<{
        inviteUrl: string;
        expiresAt: string;
        token: string;
        inviteId: string;
    ...
    const regenerateGroupInviteLink = useCallback(async (groupId: string): Promise<{
        inviteUrl: string;
        expiresAt: string;
        token: string;
        inviteId: string;
