    ...
    return (
        <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 space-y-6 animate-in fade-in duration-200">
            ...
            <div className="bg-white rounded-3xl border border-zinc-200 shadow-sm overflow-hidden">
                <div
                    className="p-6 sm:p-8 bg-zinc-900 text-white flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    <div className="flex items-center space-x-4">
                        {friendProfile.avatar_url ? (
                            ...
                            <div
                                className="w-18 h-18 rounded-2xl bg-zinc-800 ring-2 ring-zinc-700 flex items-center justify-center text-white text-2xl font-bold shrink-0">
                        ...
                        <div className="space-y-1">
                            <div className="flex items-center space-x-2 flex-wrap gap-y-1">
                                ...
                                {isRegistered ? (
                                    <span
                                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                                        <ShieldCheck className="w-3 h-3 mr-1" />
                                        Registrado
                                    </span>
                                ) : (
                                    <span
                                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/20 text-amber-300 border border-amber-500/30">
                    ...
                    {/* Balance Status Card */}
                    <div
                        className="bg-zinc-800/80 ring-1 ring-zinc-700/80 p-5 rounded-2xl shrink-0 sm:min-w-[220px] space-y-2">
                ...
                <div className="p-6 sm:p-8 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        {sharedGroups.length === 0 ? (
                            <div
                                className="p-6 bg-zinc-50 rounded-2xl text-center border border-dashed border-zinc-200">
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="space-y-1 overflow-hidden pr-2">
                                                <span
                                                    className="text-[10px] font-bold uppercase tracking-wider text-emerald-600 bg-emerald-50 border border-emerald-200 px-2 py-0.5 rounded-md inline-block">
                                            ...
                                            <ChevronRight
                                                className="w-4 h-4 text-zinc-400 group-hover:text-zinc-900 transition-colors shrink-0" />
                                        </Link>
                                    );
                                })}
                            </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="flex items-center space-x-3.5 overflow-hidden">
                                                <div
                                                    className={`w-10 h-10 rounded-xl ${catConfig.bgClass} ${catConfig.textClass} flex items-center justify-center shrink-0 border border-zinc-200/60`}>
                                            ...
                                            <div className="text-right shrink-0">
                                                ...
                                                <span
                                                    className="text-[10px] font-semibold text-zinc-400 uppercase tracking-wider block">
