...
function DashboardLayoutContent({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div
            className="min-h-screen bg-zinc-50/60 font-sans text-zinc-900 flex flex-col justify-between selection:bg-zinc-900 selection:text-white">
            <div>
                <Navbar
                    activeTab={activeTab}
            ...
            <footer className="bg-white border-t border-zinc-200 mt-auto py-8 mb-16 lg:mb-0">
                <div
                    className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-zinc-500">
