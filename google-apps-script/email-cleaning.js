...
function buildTemplatePrompt(sender, subject, cleanBody, existingEntities = [], availableExpenseTypes = []) {
    ...
    const relevantExistingPatterns = (_b = (_a = matchedExistingEntity === null || matchedExistingEntity === void 0 ? void 0 : matchedExistingEntity.patterns) === null || _a === void 0 ? void 0 : _a.filter(Boolean)) !== null && _b !== void 0 ? _b : [];
    return [
